...
%\ciii$\lambda$1906,1907 are collisionally excited lines, and are well known to be sensitive to temperature and ionization parameter \citep{Jaskot+2016}. The \ciii lines are strongest at high electron temperatures, typically associated with low-metallicity gas, and are strongest at high ionization parameter. The \ciii lines are commonly used to determine the relative abundance of carbon to oxygen, which can vary from galaxy to galaxy \citep{Berg+2016}.
%-------------------------------------------------------
% Figure 3:
%-------------------------------------------------------
\begin{figure*}
  \begin{center}
    ...
    %\includegraphics[width=0.45\linewidth]{figs/f2b.png}
...
\begin{figure*}
  \begin{center}
    ...
    %\includegraphics[width=0.45\linewidth]{figs/f3c.png}
    %\includegraphics[width=0.45\linewidth]{figs/f3d.png}
...
\begin{figure*}
  \begin{center}
    ...
    %\includegraphics[width=0.45\linewidth]{figs/f4b.png}
    %\includegraphics[width=0.45\linewidth]{figs/f4c.png}
    %\includegraphics[width=0.45\linewidth]{figs/f4d.png}
